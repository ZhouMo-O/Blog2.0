...
.paw-button .text svg {
  transition: opacity 0.2s, -webkit-transform 0.15s ease-out;
...
.paw-button .paws .paw-effect:before {
  ...
  opacity: var(--o, 1);
  transition: opacity 0.2s linear 0.25s, -webkit-transform 0.15s ease 0.16s;
  transition: transform 0.15s ease 0.16s, opacity 0.2s linear 0.25s;
  transition: transform 0.15s ease 0.16s, opacity 0.2s linear 0.25s,
    -webkit-transform 0.15s ease 0.16s;
}
...
.paw-button .paws .paw-effect div:after {
  ...
  transition: opacity 0.18s linear 0.21s, -webkit-transform 0.12s ease 0.17s;
  transition: transform 0.12s ease 0.17s, opacity 0.18s linear 0.21s;
  transition: transform 0.12s ease 0.17s, opacity 0.18s linear 0.21s,
    -webkit-transform 0.12s ease 0.17s;
}
.paw-button i {
  position: absolute;
  display: block;
